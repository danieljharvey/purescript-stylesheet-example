  ...
  component this =
    pure { state:
         ...
         , render: do
            ...
            -- the styleContext.provider uses React Context to make the Stylesheet
            -- available everywhere inside this component
            pure $ React.createLeafElement styleContext.provider
